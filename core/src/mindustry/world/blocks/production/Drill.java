...
public class Drill extends Block{
    ...
    public void drawPlace(int x, int y, int rotation, boolean valid){
        ...
        if(returnItem != null){
            ...
            String boostedRate = liquidBoostIntensity != 1 ? " ([white]" + (boost == null || !boost.liquid.hasEmoji() ? Liquids.water.emoji() : boost.liquid.emoji()) + "[]" + Strings.fixed(rate * liquidBoostIntensity * liquidBoostIntensity, 2)  + ")" : "";
